...
public class PacketManager : ModSystem
{
    ...
    internal static void PreparePacket(Packet packet, object[] context, short? sender = null)
    {
        ...
        ModPacket wrapperPacket = ModContent.GetInstance<EternityMod>().GetPacket();
    ...
    public static void ReceivePacket(BinaryReader reader)
    {
        ...
        {
            ModContent.GetInstance<EternityMod>().Logger.Warn($"Error arose when attempting to process the '{packetName}' packet: {e}");
            throw;
        }

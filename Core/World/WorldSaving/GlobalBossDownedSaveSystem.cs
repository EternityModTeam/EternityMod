...
{
    private static List<string> globalDefeatCache = new(4);
    ...
    /// </summary>
    public static string GlobalDefeatConfirmationFilePath => Path.Combine(Main.SavePath, "GlobalEternityDefeatList.txt");
    ...
    public override void OnModLoad()
    {
        ...
        EternityGlobalNPC.OnKillEvent += RegisterVanillaNPCDeaths;
    }

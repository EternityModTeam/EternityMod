...
namespace EternityMod.Core.DataStructures;
...
public class Referenced<T>
{
    ...
    // getters and setters as the Referenced<object>, it's just that their contents will be interpreted differently via the Value property.
